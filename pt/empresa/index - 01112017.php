        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-4">
              <figure class="single"><img src="../../assets/uploads/img-empresa-2.jpg" alt="" class="img-responsive"></figure>
            </div>
...
<p>Se destaca pelo grau de <strong>eficiência no cumprimento dos prazos estabelecidos e flexibilidade operacional</strong> para adequar-se às necessidades específicas de cada cliente.</p>
...
<p>Durante este tempo a SGRLOG vem crescendo suas operações e hoje conta com filiais e parceiros operacionais em todos os estados brasileiros, além de mais de 23.000 m² de área para armazenamento.</p>
