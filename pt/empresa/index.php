        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
              <h2>A SGRLOG � especializada em<br><strong>Solu��es Log�sticas</strong> </h2>
              <p>Atua desde o planejamento da melhor solu��o, implementa��o dos processos, faz a gest�o da opera��o, acompanha os indicadores de desempenho e promove melhorias cont�nuas para o aumento da performance operacional.</p>

<p>Se destaca pelo grau de <strong>efici�ncia no cumprimento dos prazos estabelecidos e flexibilidade operacional</strong> para adequar-se �s necessidades espec�ficas de cada cliente.</p>

<p>Todos os processos e controles s�o automatizados e suportados por sistemas de gest�o espec�ficos e integrados a coletores de dados e aplicativos mobile, buscando sempre maior efici�ncia nas entregas.</p>
 
<p>Com 10 anos no mercado brasileiro, seus executivos tem larga experi�ncia, adquirida em mais de 25 anos atuando no segmento log�stico em grandes empresas Nacionais e Multinacionais no segmento de Log�stica .</p>

<p>Durante este tempo a SGRLOG vem crescendo suas opera��es e hoje conta com filiais e parceiros operacionais em todos os estados brasileiros, al�m de mais de 23.000 m� de �rea para armazenamento.</p>
