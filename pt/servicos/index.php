      ...
      <section class="section">
        <div class="container">
          ...
          <div class="row">
             ...
             <p>Para atender de forma plena todas as necessidades dos seus clientes, a Complog, conta com parcerias estratégicas que lhe permitem atuar em todo território nacional, atendendo Encomendas Expressas.</p>
            </div>
          </div>
        
          <div class="row">
            <div class="col-lg-4 col-md-4">
              <figure style="margin-top:30px"><img src="../../assets/uploads/img-servicos.jpg" alt="" class="img-responsive"></figure>
            </div>
            <div class="col-lg-8 col-md-8">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h2 >Planejamos e executamos projetos dedicados em todas as modalidades:</h2>
                        </div>
                      </div>	
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6">
                              ...
                              <ul class="e-color-list">
                                <li>Entregas na última milha com Correios</li>
                                <li>Ship From Store (SFS)</li>
                                <li>Especialistas em soluções diferenciadas</li>
                                <li>Operação Reversa para Ship from Store</li>
