        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-7 col-md-7">
              <p>Atuando em todo território nacional, têm no relacionamento com seus Clientes, Fornecedores e Colaboradores o ponto forte no processo operacional.</p>
              <div class="half-space-15"></div>
              <h2>Nossa <strong>Estrutura</strong></h2>
              <p>Para atender de forma plena todas as necessidades dos seus clientes, a SGRLOG além das 08 unidades próprias, firmou parcerias estratégicas que lhe permitem atuar em todo território nacional, atendendo Encomendas Expressas, Cargas Fracionadas e Lotação.</p>
                      ...
                      <div class="call-to-action-3">
                        <div class="">
                          ...
                          <div class="">
                            ...
                            <p>Operações multimodais, com centros operacionais em várias cidades do país</p>
                          </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4">
                  ...
                  <ul class="e-color-list">
                    <li>Armazenagem e gestão de estoque</li>
                    <li>Transporte door-to-door: Aéreo e Rodoviário</li>
            ...
            <div class="col-lg-4 col-md-4">
                  ...
                  <ul class="e-color-list">
                    <li>Gestão de Operação "in house"</li>
                    <li>Consultoria em Projetos Logísticos</li>
                    <li>Logística Vertical</li>
            ...
            <div class="col-lg-4 col-md-4">
                  ...
                  <ul class="e-color-list">
                    <li>Logística Promocional</li>
                    <li>Logística Moveleira</li>
                    <li>Distribuição de concursos públicos</li>
