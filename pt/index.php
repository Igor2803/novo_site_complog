...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    * Google Fonts
    ...
    <body>
<div class="boxed-bg">
<div class="boxed"><div class="boxed-wrapper">
      ...
      <h3>menu</h3>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li><a href="../assets/index.html">wide version</a></li>
    ...
    //-->
    <i class="glyphicon glyphicon-shopping-cart" id="mobile-cart-btn"></i>
    <div class="mobile-menu" id="mobile-cart">
      <h3>shopping cart</h3>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              //-->
              <p class="contacts"><i class="fa fa-phone"></i> 0800-0000 0000</p>
              <p class="contacts"><i class="fa fa-envelope"></i> <a href="mailto:contato@sgrlog.com.br" target="_blank">contato@sgrlog.com.br</a></p>
              <!--
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="relative">
                ...
                <a href="index.html">
                <div class="logo">
                  <img src="../assets/img/logo_sgrlog.png" alt="SGRLOG">
                ...
                <nav>
                  <ul>
                    ...
                    <li><a href="javascript:void(0);">estrutura</a></li>
                    <li><a href="javascript:void(0);">filiais</a></li>
                    <li><a href="javascript:void(0);">fale conosco</a></li>
                    <li><a href="javascript:void(0);">rastreamento</a></li>
                  </ul>
                <!--
    ...
    <div class="content">
      ...
      <section class="section  home-slider">
        <div id="layerslider" class="layerslider" style="height: 500px;">
          ...
          <div class="ls-layer" style="transition3d: 1,4,5,11; transition2d: 2,8,30;">
            ...
            <img class="ls-bg" src="../assets/uploads/001.jpg" alt="layer1-background">
          ...
          <div class="ls-layer" style="transition3d: 2,3,6,14; transition2d: 4,5,23;">
            <!--LayerSlider background-->
            <img class="ls-bg" src="../assets/uploads/002.jpg" alt="layer1-background">
            <div class="layerslider-block ls-s1" style="top: 300px; left: 15px; transition2d: all; slidedelay: 6000; durationin: 1000; easingin: easeOutExpo;">
              <h3>we are</h3>
              <h2>envor</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
          ...
          <div class="ls-layer" style="transition3d: 2,3,6,14; transition2d: 4,5,23;">
            <!--LayerSlider background-->
            <img class="ls-bg" src="../assets/uploads/003.jpg" alt="layer1-background">
            <div class="layerslider-block ls-s1" style="top: 300px; left: 15px; transition2d: all; slidedelay: 6000; durationin: 1000; easingin: easeOutExpo;">
              <h3>we are</h3>
              <h2>envor</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <p>
                <a href="" class="btn  btn-primary  btn-normal"><i class="glyphicon glyphicon-check"></i> purchase now!</a>
                <a href="" class="btn  btn-secondary  btn-normal"><i class="glyphicon glyphicon-question-sign"></i> discover more</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="relative" id="latest-projects">
                <!--

                Projects Item start

                //-->
                <article class="project  padding-left-30">
                  <div class="project-inner">
                    <figure><a href=""><img src="../assets/img/img1.png" alt=""></a><figcaption><a href="../assets/img/img1.png" title="Morbi sagittis lacinia" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
                    <div class="project-details">
                      <div class="project-likes"><i class="fa fa-thumbs-o-up"></i> 14</div>
                ...
                <article class="project  padding-left-30">
                  <div class="project-inner">
                    <figure><a href=""><img src="../assets/img/img1.png" alt=""></a><figcaption><a href="../assets/img/img1.png" title="Morbi sagittis lacinia" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
                    <div class="project-details">
                      <div class="project-likes"><i class="fa fa-thumbs-o-up"></i> 21</div>
                ...
                <article class="project  padding-left-30">
                  <div class="project-inner">
                    <figure><a href=""><img src="../assets/img/img1.png" alt=""></a><figcaption><a href="../assets/img/img1.png" title="Morbi sagittis lacinia" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
                    <div class="project-details">
                      <div class="project-likes"><i class="fa fa-thumbs-o-up"></i> 6</div>
                ...
                <article class="project  padding-left-30">
                  <div class="project-inner">
                    <figure><a href=""><img src="../assets/img/img1.png" alt=""></a><figcaption><a href="../assets/img/img1.png" title="Morbi sagittis lacinia" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
                    <div class="project-details">
                      <div class="project-likes"><i class="fa fa-thumbs-o-up"></i> 30</div>
                ...
                <article class="project  padding-left-30">
                  <div class="project-inner">
                    <figure><a href=""><img src="../assets/img/img1.png" alt=""></a><figcaption><a href="../assets/img/img1.png" title="Morbi sagittis lacinia" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
                    <div class="project-details">
                      <div class="project-likes"><i class="fa fa-thumbs-o-up"></i> 17</div>
                ...
                <article class="project  padding-left-30">
                  <div class="project-inner">
                    <figure><a href=""><img src="../assets/img/img1.png" alt=""></a><figcaption><a href="../assets/img/img1.png" title="Morbi sagittis lacinia" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
                    <div class="project-details">
                      <div class="project-likes"><i class="fa fa-thumbs-o-up"></i> 25</div>
                ...
                //-->
                <div class="navigation rivaslider-navigation">
      ...
      //-->
      <section class="section  section-align-center  section-bg1" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>clients <strong>testimonials</strong></h2>
              <div class="wrapper" id="clients-testimonials">
                <!--
      ...
      //-->
      <section class="section  section-st2  section-cta2">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <p><span>Like <strong>Envor</strong> Template? Purchase in on ThemeForest!</span> <a href="" class="btn  btn-normal  btn-border-white"><i class="glyphicon glyphicon-download"></i> purchase and download</a></p>
            </div>
          </div>
        </div>
      <!--
            ...
            <div class="widget">
              ...
              <div class="widget-inner">
                ...
                <div class="quick_newsletter">
                  <form action="../assets/../assets/php/process.php">
