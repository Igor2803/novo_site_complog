...
<div class="boxed-bg"><div class="boxed"><div class="boxed-wrapper">
    ...
    <div class="content">
      ...
      //-->
      <section class="page-title-1 ti" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row">
        ...
        <div class="container">
        	...
        	<div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <p>Opera��o 100% automatizada, com tecnologia de ponta em todos as etapas dos processos, sistemas integrados de log�stica e distribui��o suportados por coletores de dados e aplicativos mobile em campo.</p>
