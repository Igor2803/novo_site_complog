      ...
      <section class="section">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
              <h2>A CompLog é especializada em<br><strong>Soluções em eccomerce</strong> </h2>
              <p>A CompLog iniciou em 2015 a partir da identificação de uma oportunidade de melhoria operacional e redução de custos, através da integração de sistemas com clientes, Correios e parceiros.</p>
