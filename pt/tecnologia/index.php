            	...
            	<div class="col-lg-4 col-md-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <figure><img src="../../assets/uploads/img-tecnologia.jpg" alt="" class="img-responsive"></figure>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12">
                    	...
                    	<h3>Emiss�o de <strong>etiquetas de c�digo de barras</strong></h3>
                        <img src="../../assets/uploads/etiqueta.gif" alt="" class="img-responsive">
                    </div>
                   	  </div>
                   </div>
                ...
                <div class="col-lg-8 col-md-8">
                	<div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 text-center">
                            <img src="../../assets/img/img-tecnologia.png" class="img-responsive">
                        </div>
                        <div class="col-lg-9 col-md-9">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <p>Utilizamos tecnologia de informa��o de ponta com sistemas integrados</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <p>Este software possibilita obter controle total dos embarques, garantindo  seguran�a e rastreabilidade de 100% dos embarques expedidos pela <strong>SGR LOG</strong>.</p>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h2>EDI - Eletronic Data Interchange</h2>
                                    <p>Para agilizar o processo em toda cadeia efetuamos a troca de informa��o entre o embarcador e a SGR LOG por meio de arquivos eletr�nicos.</p>
                                </div>
                            </div> 
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <p>Opera��o 100% automatizada, com tecnologia de ponta em todas as etapas dos processos, sistemas integrados de log�stica e distribui��o suportados por coletores de dados e aplicativos mobile em campo.</p>
<p>Fornecemos indicadores de desempenho em todos os pontos da opera��o de acordo com a necessidade de controle de cada cliente.</p>
<p>Monitoramento em tempo real de todas as unidades da SGR atrav�s do N�cleo de Monitoramento que permite durante as 24 hs do dia o acompanhamento das opera��es In House da Empresa.</p>
                        </div>
                    </div>
                </div>
